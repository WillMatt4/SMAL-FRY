...
int transfer_selection_function(
  ...
  /* trivial dirac case */		//WLM  selection -> selection_list[bin]
  if (ppt->selection_list[bin]==dirac) {
  ...
  /* gaussian case (the function is anyway normalized later
     ...
     here) */
  if (ppt->selection_list[bin]==gaussian) {
...
// WLM ffunc
if (ppt->selection_list[bin]==ffunc) {

    *selection = exp(-0.5*pow((z-ppt->selection_mean[bin])/ppt->selection_width[bin],2))
/ppt->selection_width[bin]/sqrt(2.*_PI_)*pow(comovR,2)/HubofZ;
...
// WLM zffunc
if (ppt->selection_list[bin]==zffunc) {

    *selection = z*exp(-0.5*pow((z-ppt->selection_mean[bin])/ppt->selection_width[bin],2))
/ppt->selection_width[bin]/sqrt(2.*_PI_)*pow(comovR,2)/HubofZ;
  ...
  if (ppt->selection_list[bin]==tophat) {
...
/* other useful background values for W(z) *///WLM
double comovatZ;
double hubatZ; 
...
comovatZ = pvecback[pba->index_bg_conf_distance];
hubatZ = pvecback[pba->index_bg_H];
    ...
    *use_limber = _TRUE_;
    ...
    if (_scalars_) {
      ...
      if (_index_tt_in_range_(ptr->index_tt_density, ppt->selection_num, ppt->has_nc_density) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ppt->selection_mean[index_tt-ptr->index_tt_density])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_density] != dirac) *use_limber = _TRUE_;   // WLM selection -> selection_list[argument of selection_mean]
      }
      if (_index_tt_in_range_(ptr->index_tt_rsd,     ppt->selection_num, ppt->has_nc_rsd) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ppt->selection_mean[index_tt-ptr->index_tt_rsd])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_rsd] != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_d0,      ppt->selection_num, ppt->has_nc_rsd) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ppt->selection_mean[index_tt-ptr->index_tt_d0])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_d0] != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_d1,      ppt->selection_num, ppt->has_nc_rsd) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ppt->selection_mean[index_tt-ptr->index_tt_d1])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_d1] != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_lens, ppt->selection_num, ppt->has_nc_lens) && (l>=ppr->l_switch_limber_for_nc_los_over_z*ppt->selection_mean[index_tt-ptr->index_tt_nc_lens])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_nc_lens] != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g1, ppt->selection_num, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ppt->selection_mean[index_tt-ptr->index_tt_nc_g1])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_nc_g1] != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g2, ppt->selection_num, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ppt->selection_mean[index_tt-ptr->index_tt_nc_g2])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_nc_g2] != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g3, ppt->selection_num, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ppt->selection_mean[index_tt-ptr->index_tt_nc_g3])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_nc_g3] != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g4, ppt->selection_num, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_los_over_z*ppt->selection_mean[index_tt-ptr->index_tt_nc_g4])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_nc_g4] != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g5, ppt->selection_num, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ppt->selection_mean[index_tt-ptr->index_tt_nc_g5])) {
        if (ppt->selection_list[index_tt-ptr->index_tt_nc_g5] != dirac) *use_limber = _TRUE_;
      }
      ...
      for (index_tau = 0; index_tau < tau_size; index_tau++) {
        ...
        */
        ...
        if (_index_tt_in_range_(ptr->index_tt_density, ppt->selection_num, ppt->has_nc_density))
          ...
          if (ptr->selection_bias_type[bin] == const_bias)// WLM
             rescaling = ptr->selection_bias[bin]*selection[index_tau];// WLM
          else if (ptr->selection_bias_type[bin] == desi_bias)// WLM
             rescaling = ptr->selection_bias[bin]/pvecback[pba->index_bg_D]*selection[index_tau];// WLM
          else if (ptr->selection_bias_type[bin] == eucl_bias)// WLM
                rescaling = (ptr->selection_bias[bin]+ptr->selection_bias2[bin]*(1/pvecback[pba->index_bg_a]-1))*selection[index_tau];// WLM
          else if (ptr->selection_bias_type[bin] == ska_bias)// WLM
             rescaling = (ptr->selection_bias[bin]*exp(ptr->selection_bias2[bin]*(1/pvecback[pba->index_bg_a]-1)))*selection[index_tau];// WLM
