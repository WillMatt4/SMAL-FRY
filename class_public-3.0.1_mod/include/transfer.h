...
enum selection_bias_types {const_bias,desi_bias,eucl_bias,ska_bias}; //WLM
...
struct transfer {
  ...
  double selection_bias[_SELECTION_NUM_MAX_];               /**< PARAM1 for light-to-mass bias in the transfer function of density number count */
  double selection_bias2[_SELECTION_NUM_MAX_];               /**< PARAM2 for light-to-mass bias in the transfer function of density number count */

  double selection_bias_type[_SELECTION_NUM_MAX_];               /**< number indexing the functional form of the bias to be used for each bin */
 // enum selection_bias_types selection; //WLM
  ...
  int index_tt_nc_g4;   /**< index for first bin of transfer type = gravity term G4 for of number count */
  int index_tt_nc_g5;   /**< index for first bin of transfer type = gravity term G5 for of number count */
